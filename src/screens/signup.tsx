...
export default function Signupscreen(){
    ...
    return(
    <ScrollView   contentContainerStyle={{height:"100%", width:"100%", justifyContent:"center", alignItems:"center",paddingHorizontal:25}}>
      <View style={{width:"100%",alignItems:"center",justifyContent:"center",flexDirection:"row", height:75, margin:25,marginTop:5}}>
        ...
        <Text style={{color: '#1C2340', fontSize:24, fontWeight:500}}>Sign up</Text>
        </View>
      </View>
     ...
     <Text>Name</Text>
     <TextInput placeholder="Full name" style={{width:"100%",height:54, borderColor:"#747688",borderWidth:1, borderRadius:10,paddingHorizontal:20, marginTop:5}}/>
     </View>
     
     <View style={{marginVertical:15,width:"100%",}}>
     <Text>Contact Number</Text>
     <TextInput placeholder="789874796***" style={{width:"100%",height:54, borderColor:"#747688",borderWidth:1, borderRadius:10,paddingHorizontal:20,marginTop:5}}/>
     </View>
     ...
     <TextInput placeholder="***********" style={{width:"100%",height:54, borderColor:"#747688",borderWidth:1, borderRadius:10,paddingHorizontal:20,marginTop:5}}/>
        ...
        <View style={{marginTop:50, marginBottom:30,justifyContent:"center", flexDirection:"row"}}>
